...
import com.tanpuh.kickshubservice.service.size.SizeService;
...
public class SizeController {
    ...
    public ApiResponse<SizeResponse> update(@PathVariable Integer id,
                                            @RequestBody @Valid SizeRequest request){
        return ApiResponse.<SizeResponse>builder()
                .message("Update size successfully")
                .data(sizeService.update(id, request))
                .build();
    }
